...
- `docs/exec-plans/active/2026-07-29-gate1a-rc9-c04-recovery-plan.md` — 当前 `plan_ref=52eb452a5ffec167a3809d3f372e62b9d8524124`（supersedes `05ca9bd0777280d2a455a12ddd4d6a5a46a0c086`）的 C04 纵向恢复计划；A01 与 A02 均已 fail-closed 并永久保存，A02 failed I 为 `b027ad8019d8fa46eaf7596c40eb28f470cc8c06`、preservation 为 `6752c3b4f73a17fadcfc2420c9b9c6ededeeceb9`。第二次 amendment 只修复 Node 24 wrapper defect，唯一新 Phase 6 root 为 `phase6-retry-02`；P07/P08、D16–D20、CM01 与 Gate 仍未获授权。
