...
- `docs/exec-plans/active/2026-07-26-gate1-agent-test-operations.md` — Gate 1 双轨测试运营合同；当前 RC8 roster 为 `A30`–`A36`，定义同一 RC、隔离、A37 起替补和报告边界；独立测试运营负责人当前为 `/root/gate1a_test_ops_lead`。A30 技术无效并由 A37 替补；A31–A36 有效，当前 6/7。
- `docs/exec-plans/active/2026-07-26-gate1-dual-track-independent-review.md` — 双轨合同独立复核；最终 P0=0 / P1=0 / P2=0 / REVIEW_PASS。
- `docs/exec-plans/active/2026-07-26-gate1-d0-readiness.md` — D0-A 已通过；RC7 预启动作废，RC8 cohort `g1a-20260726-rc8-01` 已取得独立 `RC_FREEZE=YES`。A30 技术无效并由 A37 替补；A31–A36 有效，当前 6/7。
