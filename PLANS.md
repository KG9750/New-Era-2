...
- `docs/exec-plans/active/2026-07-26-gate1-d0-readiness.md` — D0-A 已 `READY`；#2–#7、`M-A`–`M-C` 和 Vite 8 RC4 均已完成，cohort `g1a-20260726-rc4-01` 已取得 `RC_FREEZE=YES`，进入 A01–A07 运营。
