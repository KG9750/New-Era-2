...
- Gate 1A 当前为 `RUNNING_5_OF_7_VALID_A37_PENDING`：A30 因并发 A30/M-C 身份污染而技术无效，A37 为首个替补；A31–A35 有效。A33、A34 独立复现 P2 `WEEK2_PRESTART_TIME_LABEL_TRANSITION`，未影响决策、完成、保存或清空，仍未构成独立 P1；A35 无新增 P0/P1/P2。
