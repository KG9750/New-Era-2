...
- Gate 1 两周 RC5 候选已固定为 `refs/heads/codex/gate1-rc-20260726.5`，指向提交 `2d40aa102bd51107c07cbe176f798a93a37663f3`；artifact 为 `ec09284f9dfb7976356a510b1039092f85dc91dd6eb94e649ca138040431d65f`，cohort `g1a-20260726-rc5-01` 正在等待独立冻结复核，尚未取得 `RC_FREEZE=YES`。
- `g1a-20260726-rc2-01` 因玩家包诱导风险被否决；rc2-02 因 Vite 7 基线偏差被替代；rc3-01 因独立审查发现两项状态一致性 P1 被替代。三者均未产生正式样本。
- `M-A`–`M-C` 已完成且不进入正式分母；#7 仍为 `OPEN`，只在 RC5 独立复核通过后关闭。
...
- Gate 1A 当前为 `RC5_FREEZE_PENDING`：RC5 通过后，正式样本改为 A09–A15，按 `A09–A11 / A12–A14 / A15` 执行，替补从 A16 开始；对应新 Issues 尚未创建。
