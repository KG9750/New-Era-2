...
- Gate 1A 当前为 `IN_PROGRESS_1_OF_7_VALID_A37_PENDING`：A30 因并发 A30/M-C 身份污染而技术无效，A37 为首个替补；A31 已通过交接对账确认归属于独立 `/root/gate1a_a31`，与 A30/M-C 不重叠，完整保留玩家包、首次观察、同页冻结续存、字节一致下载、清空和访谈 V4，最终裁定为 `VALID`。交接摘要中的“A31 paused”是可见性缺口，不再视为未知控制面事件。
