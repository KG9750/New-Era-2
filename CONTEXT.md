...
- Gate 1 两周 RC8 已固定为 `refs/heads/codex/gate1-rc-20260726.8`，指向提交 `03973fcfc0c244555e7e4a4c623eec3fb8b8e032`；artifact 为 `e0cf7c78251642a54f88845c61aa214e9e91076b3e432fb8399bd873ef0fe49b`。cohort `g1a-20260726-rc8-01` 已制备并等待独立复核，尚未取得 `RC_FREEZE=YES`。
- `g1a-20260726-rc2-01` 因玩家包诱导风险被否决；rc2-02 因 Vite 7 基线偏差被替代；rc3-01 因独立审查发现两项状态一致性 P1 被替代。三者均未产生正式样本。
- `M-A`–`M-C` 已完成且不进入正式分母；#7 当前保持 `OPEN`。
...
- Gate 1A 当前为 `RESTART_PENDING_RC8_FREEZE`：RC8 计划使用 A30–A36，按 `A30–A32 / A33–A35 / A36` 执行，替补从 A37 开始；独立 `RC_FREEZE=YES` 前不得创建或启动正式 player agent。
