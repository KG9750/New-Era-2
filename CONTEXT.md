...
- RC9 C01 因 D02 重启同一诊断编号被拒绝；C02 因 W1/W2 人工 v2 中位数均为 `2` 被拒绝；C03 虽达到原诊断数值门槛，但在 freeze preparation 因 manifest verifier 仍硬编码 v0.2/`0.5.0`，且 D15 的 standalone Codex CLI 未获场前合同授权，最终以 `REJECTED_FREEZE_PREPARATION` 拒绝。C01–C03、P01–P06、D01–D15 永久只读，`CM01` 未创建、未分配、未消耗。当前权威入口为 `docs/exec-plans/active/2026-07-29-gate1a-rc9-c04-recovery-plan.md`，当前 `plan_ref=52eb452a5ffec167a3809d3f372e62b9d8524124`，并 supersede `05ca9bd0777280d2a455a12ddd4d6a5a46a0c086`；更早父权威只保留为历史版本限定。C04 只修复 versioned manifest authority、真实 hash 复算、预授权的 `standalone-codex-cli-v2` 隔离证据及第二次 amendment 明确授权的 Node 24 wrapper defect；P07/P08、D16–D20 与 CM01 仍未获授权。
