...
- Gate 1A 当前为 `SEALING_7_OF_7_VALID_PENDING_AGGREGATION`：A30 因并发 A30/M-C 身份污染而技术无效，A37 已完成对 A30 的替补；A31–A37 共七个有效样本已齐。A33、A34、A36、A37 四个有效独立样本复现 `WEEK2_PRESTART_TIME_LABEL_TRANSITION`，确认为系统性 P2；未影响决策、完成、保存或清空，不构成独立 P1。
