...
Use `YYYY-MM-DD-short-topic.md` for active plans.

Each plan should include goal, success criteria, steps, verification, and risks.
...
- `data/playtests/weekly-management-slice/gate1a/g1a-20260726-rc8-01/gate1a-final-report.md`: Gate 1A RC8 post-seal 最终报告；W1/W2 中位数 `2 / 1`，`P0=0 / P1=2 / P2=1`，结论 `AGENT_PROXY_FAIL`；Gate 1H `PENDING`，Gate 2 `LOCKED`。
