...
**当前结论：** `D14_RC3_FROZEN / GATE_1A_AWAITING_FREEZE_REVIEW / GATE_1H_DEFERRED`
...
| Gate 1 正式 RC | 完成 | rc2 在 A01 前因 Vite 7 基线偏差标记为 `SUPERSEDED`；`refs/heads/codex/gate1-rc-20260726.3` 固定指向 `57621e670e69a2b4c7c283a6614ab1bdefd71ca1`，双 clean clone 得到相同 Vite 8 artifact hash |
| Gate 1A cohort manifest | 完成 | `g1a-20260726-rc2-01` 因玩家包诱导风险在开跑前被否决；`g1a-20260726-rc2-02` 因 Vite 7 基线偏差被替代；`g1a-20260726-rc3-01` 已以两阶段协议冻结，正式样本尚未开始 |
...
- `TECH-A98`、`TECH-A99` 与 `TECH-P00` 只用于技术审计，不得改作正式样本或替补；
...
1. 将 RC3 cohort manifest、archive 与冻结证据发布到远端实施分支，保持 RC3 ref 不移动；
